  ...
  { 
    ...
    if( SerialCommand.length()==1 ){
      ...
      case  'b' :     // 接收到 'b'，做您要的動作2 設定名字
        Serial.println("AT+NAMEmasterLin\r");
        BTSerial.write("AT+NAMEmasterLin\r\n");
        break;
      ...
      case  'm' :     // 接收到 'b'，做您要的動作2
        Serial.println("AT+DEFAULT\r");
        BTSerial.write("AT+DEFAULT\r\n");
        break;
      case  'n' :     // 接收到 'b'，做您要的動作2  查詢rssi <藍牙地址><設備類型><rssi>
        Serial.println("AT+INQS\r");
        BTSerial.write("AT+INQS\r\n");
        break;
